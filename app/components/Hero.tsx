...
export default function HeroSection() {
    ...
    return (
        <section className="relative overflow-hidden bg-[url('/bgimage/herobgimage.jpg')] bg-no-repeat bg-center bg-cover min-h-screen">
            <div className="mx-auto w-full px-6 py-20 md:px-12 lg:px-20 lg:py-32">
